# v0.1 Generic Full-Paper Skill

This version is a release-facing NatureOrchestrator skill snapshot for generic
scientific manuscript writing. It is derived from benchmark development, but it
does not require NatureBench data and does not assume an oracle manuscript.
